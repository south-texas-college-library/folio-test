...
SELECT
    ...
    concat('<a href="https://stc.folio.indexdata.com/inventory?filters=staffSuppress.false&qindex=items.barcode&query=', jsonb_extract_path_text(i.jsonb, 'barcode'), '&segment=items&sort=title" target="_blank" rel="noopener">',jsonb_extract_path_text(i.jsonb, 'barcode'), '</a>') as g_barcode,
